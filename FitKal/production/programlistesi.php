        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
			...
			<div class="col-md-12 col-sm-12  ">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Antrenman Programları <br><small>Veriler anlık olarak güncellenmektedir. </small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table class="table table-striped jambo_table bulk_action" id="dinamik">
					  <thead>
						<tr>
						  ...
						  <th>Bölge</th>
						  <th>Hareketler</th>
						  <th>Set Sayısı ve Tekrarlar</th>
						  <th>Setler Arası Dinlenme Süresi</th>
					  ...
					  $programQuery = mysqli_query($baglan,"
						SELECT bolgeID, bolge, hareketler, setSayisi, SetDinlenme
						FROM fitnessProgramlari
						
					  ");
					  
					  if(mysqli_num_rows($programQuery) != 0){
						  
						  while($readProgram = mysqli_fetch_array($programQuery)){
							  
							  $bolgeID = $readProgram['bolgeID'];
							  $bolge = $readProgram['bolge'];
							  $hareketler = $readProgram['hareketler'];
							  $setSayisi = $readProgram['setSayisi'];
							  $setDinlenme = $readProgram['setDinlenme'];
							  
							  							  					  
					  ?>
					  
						<tr>
						  <td><?php echo $bolgeID; ?></td>
						  <td><?php echo $bolge; ?></td>
						  <td><?php echo $hareketler; ?></td>
						  <td><?php echo $setSayisi; ?></td>
						  <td><?php echo $setDinlenme; ?></td>
						  
						  
						  <!-- işlemsel ayarlarımızı bu kısımda gerçekleştiriyoruz -->
						  <td style="<?php echo $tableStyle; ?>">
							<a href='guncelle.php?bolgeID=<?php echo $bolgeID; ?>&user_id=<?php echo $userID; ?>' style='width:100px; font-size:12px;' class='btn btn-primary btn-xs'><i class='fa fa-search'></i> Düzenle </a>
							<a href='sil.php?bolgeID=<?php echo $bolgeID; ?>&user_id=<?php echo $userID; ?>' style='width:100px; font-size:12px;' class='btn btn-danger btn-xs'><i class='fa fa-pencil'></i> Sil </a>
						  </td>
